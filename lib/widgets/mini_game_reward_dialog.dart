...
/// game-specific icons, gradients, and text styles.
class MiniGameRewardDialog extends StatefulWidget {
  final String title;
  ...
  @override
  State<MiniGameRewardDialog> createState() => _MiniGameRewardDialogState();
}

class _MiniGameRewardDialogState extends State<MiniGameRewardDialog> {

...
///
/// Under the Phase-6 soft-cap economy, games are NEVER hard-blocked.
/// The [rewardAmount] displays the actual per-round payout (e.g. +31 RBX)
/// while [earnedToday]/[totalCap] shows Tier-1 progress (0 / 1,200).
class GameCardEnhanced extends StatefulWidget {
  final GameItemData game;
  final int earnedToday;
  final int totalCap;

  /// Kept for API compatibility (used by getRemainingCap calls upstream),
  /// but not displayed on this card — use [rewardAmount] instead.
  final int remainingCap;

  /// Actual per-round payout shown in the coin pill (e.g. +31 RBX).
  /// Falls back to 31 when omitted (Tier-1 premium reward for most games).
...
class _GameCardEnhancedState extends State<GameCardEnhanced> {
  ...
  Widget build(BuildContext context) {
    ...
    // Per-round reward displayed in the pill (e.g. "Up to +31" or "+48")
        ...
        child: Container(
          ...
          child: ClipRRect(
            ...
            child: Column(
              ...
              children: [
                // Game Image with floating badges
                Expanded(
                  child: Padding(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Tier-1 Progress Bar (0 → 1,200 coins)
                      ClipRRect(
                      ...
                      // Progress text: "Earned today  3 / 1,200"
                      Row(
                      ...
                      // Bottom Row: reward pill + play button
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          // Per-round reward pill (e.g. "+31 RBX 🪙")
                          Container(
                            padding: const EdgeInsets.symmetric(
                              horizontal: 7,
                              vertical: 3.5,
